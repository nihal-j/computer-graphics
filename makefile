...
main: main.o
	$(CC) -g build/main.o build/glad.o build/graphics_engine.o build/line.o build/circle.o build/tree.o $(GL_FLAGS) -o main
...
main.o: main.cpp line.o circle.o graphics_engine.o glad.o tree.o
