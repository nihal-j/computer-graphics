...
/**
 * @brief Class `Sphere` extends `ObjectBase`. It is used to add spheres to the scene and perform operations related to rendering of this object (getting a normal, testing for intersection with a `Ray`).S
 * 
 */
